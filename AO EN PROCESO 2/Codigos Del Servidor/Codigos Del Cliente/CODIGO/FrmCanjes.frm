...
Call SendData("IPX" & ListaPremios.ListIndex + 1)
bAceptar.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BcanjearN.jpg")
bSalir.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BsalirN.jpg")
Me.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_main.jpg")
End Sub

Private Sub baceptar_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
bAceptar.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BcanjearA.jpg")
End Sub

Private Sub baceptar_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
bAceptar.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BcanjearI.jpg")
End Sub

Private Sub bsalir_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
bSalir.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BsalirA.jpg")
End Sub

Private Sub bsalir_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
bSalir.Picture = LoadPicture(App.path & "\Recursos\Graficos\Principal\Canjear_BsalirI.jpg")
End Sub
