...
Select Case Index
    ...
    Case 1
        ...
        frmConnect.FONDO.Picture = LoadPicture(App.path & "\Recursos\Graficos\conectar.jpg")
        Me.Visible = False
...
SkillPoints = 10
Puntos.Caption = SkillPoints
Me.Picture = LoadPicture(App.path & "\Recursos\graficos\CP-Interface.jpg")
imgHogar.Picture = LoadPicture(App.path & "\Recursos\graficos\CP-Ullathorpe.jpg")
...
Image1.Picture = LoadPicture(App.path & "\Recursos\graficos\" & lstProfesion.Text & ".jpg")
Call TirarDados
End Sub
