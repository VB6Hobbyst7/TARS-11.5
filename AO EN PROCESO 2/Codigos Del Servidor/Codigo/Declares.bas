...
Public HayEvento As Boolean
Public GmPos As Integer
Public Evento As Long
...
'.INI
Public Dados(1) As Byte
Public OROMO As String
Public EXPMO As String
...
Public aDos As New ClsAntiDos 'Anti D.o.o.s
...
Public Const AumentoSTNigro As Byte = AumentoSTDef + 2
...
'Texto
Public Const FONTTYPE_ERRORX As String = "~255~255~255~1~0"
Public Const FONTTYPE_FRIENDOFF As String = "~255~0~0~1~0"
Public Const FONTTYPE_VENENOXX As String = "~0~255~0~1~0"
Public Const FONTTYPE_CONSOLA As String = "~0~128~128~1~0"
Public Const FONTTYPE_GLOBAL As String = "~255~154~38~1~0"
Public Const FONTTYPE_TALK As String = "~255~255~255~1~0"
Public Const FONTTYPE_FIGHT As String = "~255~0~0~1~0"
Public Const FONTTYPE_WARNING As String = "~32~51~223~1~0"
Public Const FONTTYPE_ROJO As String = "~255~0~0~1~0"
Public Const FONTTYPE_AMARRILLO As String = "~255~255~0~1~0"
Public Const FONTTYPE_AZUL As String = "~0~0~255~1~0"
Public Const FONTTYPE_INFO As String = "~65~190~156~1~0"
Public Const FONTTYPE_EVENTO As String = "~255~200~145~0~0"
Public Const FONTTYPE_TSUBASTA As String = "~255~255~255~1~0"
Public Const FONTTYPE_TDSUBASTA As String = "~255~255~255~1~0"
Public Const FONTTYPE_SUBASTA As String = "~48~128~255~1~0"
Public Const FONTTYPE_INFOBOLD As String = "~65~190~156~1~0"
Public Const FONTTYPE_EJECUCION As String = "~130~130~130~1~0"
Public Const FONTTYPE_PARTY As String = "~255~180~255~1~0"
Public Const FONTTYPE_VENENO As String = "~0~255~0~1~0"
Public Const FONTTYPE_GUILD As String = "~255~255~255~1~0"
Public Const FONTTYPE_SERVER As String = "~0~185~0~1~0"
...
Public Type tCristales
    CristalesPequeñosMin As Byte
    CristalesPequeñosMax As Byte
...
'index de la particula
Public Enum ParticulaId
    PARTICLECHICO = 34
    PARTICLEMEDIANO = 2
    PARTICLEGRANDE = 35
    PARTICLEXGRANDE = 36
...
Public Type UserFlags
    ...
    OrganizadorEvento As Byte
    ViejaVidaMin As Integer
    ViejaVidaMax As Integer
    ViejaManaMin As Integer
    ViejaManaMax As Integer
