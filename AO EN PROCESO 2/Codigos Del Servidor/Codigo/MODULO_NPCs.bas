...
Npclist(NpcIndex).GiveEXP = val(Leer.GetValue("NPC" & NpcNumber, "GiveEXP")) * EXPMO
...
Npclist(NpcIndex).GiveGLD = val(Leer.GetValue("NPC" & NpcNumber, "GiveGLD")) * OROMO
...
'#####CRISTALES####
    Npclist(NpcIndex).Invent.DropCristales = val(Leer.GetValue("NPC" & NpcNumber, "DropCristales"))
    Npclist(NpcIndex).Cristales.CristalesPequeñosMin = val(Leer.GetValue("NPC" & NpcNumber, "CristalesPequeñosMin"))
    Npclist(NpcIndex).Cristales.CristalesPequeñosMax = val(Leer.GetValue("NPC" & NpcNumber, "CristalesPequeñosMax"))
    Npclist(NpcIndex).Cristales.CristalesMedianosMin = val(Leer.GetValue("NPC" & NpcNumber, "CristalesMedianosMin"))
    Npclist(NpcIndex).Cristales.CristalesMedianosMax = val(Leer.GetValue("NPC" & NpcNumber, "CristalesMedianosMax"))
    Npclist(NpcIndex).Cristales.CristalesGrandesMin = val(Leer.GetValue("NPC" & NpcNumber, "CristalesGrandesMin"))
    Npclist(NpcIndex).Cristales.CristalesGrandesMax = val(Leer.GetValue("NPC" & NpcNumber, "CristalesGrandesMax"))
    Npclist(NpcIndex).Cristales.CristalesEpicosMin = val(Leer.GetValue("NPC" & NpcNumber, "CristalesEpicosMin"))
    Npclist(NpcIndex).Cristales.CristalesEpicosMax = val(Leer.GetValue("NPC" & NpcNumber, "CristalesEpicosMax"))
