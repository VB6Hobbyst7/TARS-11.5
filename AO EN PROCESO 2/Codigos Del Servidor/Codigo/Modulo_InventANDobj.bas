...
'#####CRISTALES####
If npc.Invent.DropCristales > 0 Then

Dim equisrandom As Byte
Dim yyrandom As Byte
equisrandom = npc.Pos.x
yyrandom = npc.Pos.y
 
 If npc.Cristales.CristalesPequeñosMin > 0 Then
    For i = npc.Cristales.CristalesPequeñosMin To RandomNumber(npc.Cristales.CristalesPequeñosMin, npc.Cristales.CristalesPequeñosMax)
         npc.Pos.x = equisrandom + RandomNumber(0, 3)
         npc.Pos.y = yyrandom + RandomNumber(0, 3)
            MiObj.Amount = 1
            MiObj.ObjIndex = 858
            Call TirarItemAlPiso(npc.Pos, MiObj)
    Next i
 End If
  ...
  If npc.Cristales.CristalesMedianosMin > 0 Then
    For i = npc.Cristales.CristalesMedianosMin To RandomNumber(npc.Cristales.CristalesMedianosMin, npc.Cristales.CristalesMedianosMax)
            MiObj.Amount = 1
            MiObj.ObjIndex = 859
            Call TirarItemAlPiso(npc.Pos, MiObj)
    Next i
 End If
  ...
  If npc.Cristales.CristalesGrandesMin > 0 Then
    For i = npc.Cristales.CristalesGrandesMin To RandomNumber(npc.Cristales.CristalesGrandesMin, npc.Cristales.CristalesGrandesMax)
            MiObj.Amount = 1
            MiObj.ObjIndex = 860
            Call TirarItemAlPiso(npc.Pos, MiObj)
    Next i
 End If
  ...
  If npc.Cristales.CristalesEpicosMin > 0 Then
    For i = npc.Cristales.CristalesEpicosMin To RandomNumber(npc.Cristales.CristalesEpicosMin, npc.Cristales.CristalesEpicosMax)
            MiObj.Amount = 1
            MiObj.ObjIndex = 861
            Call TirarItemAlPiso(npc.Pos, MiObj)
    Next i
