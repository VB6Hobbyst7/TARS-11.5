...
cmdOfrecer.Picture = LoadPicture(App.path & "\Recursos\GRAFICOS\Principal\Almas_OfrecerN.jpg")
End Sub
...
cmdOfrecer.Picture = LoadPicture(App.path & "\Recursos\GRAFICOS\Principal\Almas_OfrecerI.jpg")
End Sub
Private Sub cmdOfrecer_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
cmdOfrecer.Picture = LoadPicture(App.path & "\Recursos\GRAFICOS\Principal\Almas_OfrecerA.jpg")
End Sub
