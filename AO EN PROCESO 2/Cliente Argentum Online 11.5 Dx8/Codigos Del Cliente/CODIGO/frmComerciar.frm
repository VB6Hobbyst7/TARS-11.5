...
Me.Picture = LoadPicture(App.path & "\Recursos\Graficos\comerciar.jpg")
...
Select Case Index
    Case 0
        If Image1(0).Tag = 1 Then
                Image1(0).Picture = LoadPicture(App.path & "\Recursos\Graficos\BotónComprarApretado.jpg")
                Image1(0).Tag = 0
                Image1(1).Picture = LoadPicture(App.path & "\Recursos\Graficos\Botónvender.jpg")
                Image1(1).Tag = 1
        End If
    ...
    Case 1
        If Image1(1).Tag = 1 Then
                Image1(1).Picture = LoadPicture(App.path & "\Recursos\Graficos\Botónvenderapretado.jpg")
                Image1(1).Tag = 0
                Image1(0).Picture = LoadPicture(App.path & "\Recursos\Graficos\BotónComprar.jpg")
                Image1(0).Tag = 1
        End If
